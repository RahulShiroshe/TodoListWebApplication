...
//         <Switch>
//           <Route path='/' exact render={ () => <Pages productItems={productItems} addToCart={addToCart} shopItems={shopItems} />}>
            
//           </Route>
//           <Route path='/cart' exact render={ () => <Cart CartItem={CartItem} addToCart={addToCart} decreaseQty={decreaseQty} removeQty={removeQty} />}>
...
// // import React from 'react'
// // import Header from './New/common/header/Header'
